        ...
        return (
          <div
            className={cn(
              ...
              current
                ? "border-[var(--ft-accent)]/40 bg-[var(--ft-accent)]/8"
                : complete
                  ? "border-[var(--ft-green)]/25 bg-[var(--ft-green)]/5"
                  : "border-[var(--ft-border)] bg-[var(--ft-bg-raised)]"
            )}
            key={step.label}
          >
            <div className="flex items-center gap-2">
                ...
                className={cn(
                  ...
                  current
                    ...
                    : complete
                      ...
                      : "bg-[var(--ft-bg-muted)] text-[var(--ft-text-muted)]"
                )}
              >
              ...
              <div className="min-w-0">
                ...
                {step.description ? (
                  <div className="mt-0.5 truncate text-[10px] text-[var(--ft-text-muted)]">
                    {step.description}
                  </div>
                ) : null}
              </div>
