...
import { RefreshCw, Search, ShieldAlert, Users, Radio, Eye, Megaphone } from "lucide-react";
...
export default function GrowthServicesPage() {
  ...
  const visibleServices = useMemo(
    () => activeServices.filter((service) => {
      ...
      return `${service.name} ${service.platform} ${service.category} ${service.description}`.toLowerCase().includes(normalizedQuery);
    }),
  ...
  return (
    <>
      <PageHeader
        ...
        eyebrow={<><Badge tone={growthEnabled ? "success" : "warning"}>{growthEnabled ? "Orders open" : "Setup mode"}</Badge><Badge tone="info">Managed delivery</Badge></>}
