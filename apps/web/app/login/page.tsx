...
// The command centre, not the AI studio: Home is the post-login destination.
        ...
        >
          ...
          <div className="rounded-[var(--radius-xl)] border border-[var(--ft-border)] bg-[var(--ft-bg-raised)] p-8 shadow-[var(--shadow-lg)]">
            ...
            <p className="mt-2 text-sm text-[var(--ft-text-secondary)]">
              Sign in to continue to FlipTrybe.
            </p>
                ...
                <>
                  ...
                  <div className="grid gap-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <a
                        className="text-xs font-medium text-[var(--ft-accent)] transition hover:text-[var(--ft-accent-dim)]"
          ...
          <p className="mt-6 text-center text-xs text-[var(--ft-text-muted)]">
            Just need airtime or to pay a bill?{" "}
            <a
              className="font-medium text-[var(--ft-accent)] underline transition hover:text-[var(--ft-accent-dim)]"
              href="/guest"
            >
