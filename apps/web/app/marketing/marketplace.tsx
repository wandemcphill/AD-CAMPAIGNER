        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          {visibleResults.map((talent, index) => (
            <motion.article
              ...
              className="min-h-[260px] rounded-md border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl"
              key={talent.name}
          ...
          {visibleResults.length === 0 ? (
            <div className="rounded-md border border-white/10 bg-white/[0.04] p-5 text-white/58 md:col-span-2 xl:col-span-5">
